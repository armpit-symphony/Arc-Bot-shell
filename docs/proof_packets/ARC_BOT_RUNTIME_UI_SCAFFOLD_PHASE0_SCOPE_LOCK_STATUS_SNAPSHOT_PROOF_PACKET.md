...
- `python -m pytest -p no:cacheprovider --basetemp tmp_pytest -q tests/test_arc_bot_runtime_ui_scaffold_phase_chain.py` (recommended in non-admin Windows temp environments)
